...
aoi_Aus <- c(112, -44, 154, -10)
Au_surface_clay <- get_soils_data(product = 'NAT', attribute = 'CLY',
                                   component = 'VAL', depth = 1,
                                   aoi = aoi_Aus, write_out = FALSE )
```
...
## Landscape data (Not sure if we need this data)
